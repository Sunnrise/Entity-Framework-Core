...
////If we use AsNoTracking method, the entities will be returned as different instances. So, if we want to get the same instance of the entity, we can use AsNoTrackingWithIdentityReso lution method.
